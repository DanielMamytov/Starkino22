package co.nisari.katisnar.presentation.ui.stararticle.model
...
object StarArticleDataSource {
    ...
    private val seeds = listOf(
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img1,
        ),
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img2,
        ),
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img3,
        ),
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img4,
        ),
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img5,
        ),
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img6,
        ),
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img7,
        ),
        ArticleSeed(
            ...
            """.trimIndent(),
            coverResId = R.drawable.article_img8,
        ),
        ArticleSeed(
    ...
    private fun ArticleSeed.toListItem(id: Long): ArticleListItem {
        ...
        val preview = trimmedContent.split("\n\n").firstOrNull()?.trim().orEmpty()
